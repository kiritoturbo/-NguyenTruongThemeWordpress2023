        ...
        <div class="wrapper">
            ...
            <div class="logo" >
                <a href="<?php bloginfo('url') ?>">
                    <!-- <img style="max-width: 150px;height: 64px;object-fit:cover;" src="<?php echo ((get_field('image_logo'))['url'] ); ?>" alt="" /> -->
                    <?php 
                        ...
                        if ( has_custom_logo() ) {
                            ...
                            echo '<img style="max-width: 150px;height: 64px;object-fit:cover;" src="'.$logoCustom.' ?>" alt="" />';
                        }
                    ?>
                </a>
            </div>
