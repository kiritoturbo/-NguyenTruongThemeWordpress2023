<section class="contact">
            <div class="contact-item">
                ...
                <div class="item-right">
                    ...
                    <p class="content"><?php echo esc_html( get_field('lien_he') ); ?></p>
                </div>
            </div>
            <div class="contact-item">
                ...
                <div class="item-right">
                    ...
                    <p class="content"><?php echo esc_html( get_field('email_contact') ); ?></p>
                </div>
            </div>
            <div class="contact-item">
                ...
                <div class="item-right">
                    ...
                    <p class="content"><?php echo esc_html( get_field('diachi') ); ?></p>
                </div>
            </div>
        </section>